...
const addEntry = (newItem) => {
    bookList.unshift(newItem);
    return bookList;
}

const removeEntry = (position) => {
    DataTransferItemList.splice(position, 1)
    return bookList;
}

const listEach = (bookList) => {
    for (const a in bookList){
        console.log(bookList.a.title)
    }
}
...
switch (day){
    ...
    case "Friday":
        ...
        break;
    default:
        console.log("Gotta say a day man");
        break;
